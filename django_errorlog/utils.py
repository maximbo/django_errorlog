...
def log_error(exc_info=None, name=None):
    '''
    Logs exc_info into 'exception' and 'traceback' logs with ERROR level.
    If exc_info is None get it from sys.exc_info().
    '''
    _log_exc_info(exc_info, level=logging.ERROR, name=name)

def log_warning(exc_info=None, name=None):
    '''
    Logs exc_info into 'exception' and 'traceback' logs with WARNING level.
    If exc_info is None get it from sys.exc_info().
    '''
    _log_exc_info(exc_info, level=logging.WARNING, name=name)
